  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        const MaxContainer(child: FeatureContent())
      ],
    );
  }
}
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
            ...
            colors: [
              ...
              const Color.fromARGB(255, 28, 0, 52)
            ]),
            ...
            LayoutGrid(
              ...
              children: [
                ...
                FeatureItem(
                    ...
                    icon:
                        Image.asset('assets/mobile-analytics.png', height: 50)),
                FeatureItem(
...
class FeatureItem extends ConsumerStatefulWidget {
  const FeatureItem({
    required this.title,
...
class FeatureItemState extends ConsumerState<FeatureItem> {
